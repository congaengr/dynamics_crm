...
describe Mscrm::Soap::Client do
  let(:subject) { Mscrm::Soap::Client.new(organization_name: "tinderboxdev")}
  ...
  describe "#retrieve_multiple" do
    it "should retrieve multiple entities by criteria" do
      ...
      result.should be_a(Mscrm::Soap::Model::RetrieveMultipleResult)
  ...
  describe "#create" do
    it "creates new entity with parameters" do
      ...
      result.should be_a(Mscrm::Soap::Model::CreateResult)
  ...
  describe "#update" do
    it "updates entity by id" do
      ...
      result.should be_a(Mscrm::Soap::Model::UpdateResult)
    end
  end
  ...
  describe "#delete" do
    it "deletes entity by id" do
      ...
      result.should be_a(Mscrm::Soap::Model::DeleteResult)
    end
  end
  ...
  describe "#retrieve_all_entities" do
    it "retrieve entity list" do
      ...
      result.should be_a(Mscrm::Soap::Metadata::RetrieveAllEntitiesResponse)
  ...
  describe "#retrieve_entity" do
    it "retrieve entity metadata" do
      ...
      result.should be_a(Mscrm::Soap::Metadata::RetrieveEntityResponse)
      result.entity.should_not be_nil
      entity = result.entity
      entity.should be_a(Mscrm::Soap::Metadata::EntityMetadata)
  ...
  describe "#retrieve_attribute" do
    it "retrieve attribute metadata" do
      ...
      result.should be_a(Mscrm::Soap::Metadata::RetrieveAttributeResponse)
